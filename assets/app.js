...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-what-sql-is.html", "a2-reading-a-query.html",
           "a3-judging-a-claim.html", "a4-dashboard-behind.html",
           "a5-asking-right-cut.html", "a6-sql-warehouses-ai.html"]
        : ["b1-meet-your-database.html", "b2-filtering-rows.html", "b3-aggregating.html",
           "b4-joining-tables.html", "b5-combining-reshaping.html",
           "b6-subqueries-ctes.html", "b7-window-functions.html",
           "b8-building-changing-data.html", "b9-analyst-case-study.html", "b10-performance-warehouses.html"];
